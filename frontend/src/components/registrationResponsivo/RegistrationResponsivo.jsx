...
export const RegistrationResponsivo = ({ open, setOpen }) => {
    ...
    return (
        <>
                    ...
                    >
                        <div className={`${namespace}-title`}>
                            <Typography
                                ...
                                variant="h6"
                                component="h2"
                                sx={{ color: "white", fontWeight: "bold", fontSize: { xs: "32px", sm: "40px" } }}
                            >
                        ...
                        <Box sx={{ display: "flex", flexDirection: "column", gap: 2, width: "95%" }}>
                            <TextField
                        ...
                        <Box sx={{ display: "flex", gap: 2 }}>
                            <Typography sx={{ mt: 2, color: "white" }}>¿Ya tienes una cuenta?</Typography>
            ...
            <ReenvioEmailRegistroExitoso open={showReenvioModal} onClose={() => setShowReenvioModal(false)} />
        </>
    );
};
