...
/*   //Verificar si el usuario tiene booking para este producto
  ...
  const availableDates =
    product.availabilitySet?.map((avail) => avail.date) || [];
  const maxCapacity =
              ...
              <Grid item xs={6} key={index} sx={{ position: "relative" }}>
                ...
                {index === arr.length - 1 && product.imageSet.length >= 5 && (
                  <Button
                    ...
                    onClick={() => navigate("/gallery", { state: { product } })}
                    sx={{
                      position: "absolute",
                      bottom: 10,
                      right: 10,
            ...
            <Box sx={{ mt: 2 }}>
              {[
                ...
                },
                {
                  ...
                  label: "Incluido:",
                  value:
                    product.features.length > 0 ? null : "Consultar detalles",
                },
              ].map((detail, index) => (
                <Box
                  key={index}
        ...
        <Grid item xs={12} md={4}>
          ...
          >
            <Typography
              variant="h5"
              fontWeight="bold"
              sx={{ mb: 4, color: "#1C274C", fontSize: "1.8rem" }}
            >
            ...
            <Box sx={{ display: "flex", alignItems: "center", mt: 3, mb: 3 }}>
              ...
              >
                <AddIcon
                  sx={{
                    color: selectedPeople < maxCapacity ? "#FD346E" : "gray",
                  }}
                />
              </IconButton>
            </Box>
            ...
            <Typography
              fontWeight="bold"
              sx={{ mb: 3, fontSize: "1.5rem", color: "#1C274C" }}
            >
          ...
          return (
            <Card key={rev.id} sx={{ mb: 3, borderRadius: "16px" }}>
              <CardHeader
                ...
                avatar={<Avatar sx={{ bgcolor: "#00CED1" }}>{initials}</Avatar>}
                title={
